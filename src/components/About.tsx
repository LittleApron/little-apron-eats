        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4 text-lg text-muted-foreground">
              <p>
                Welcome to Little Apron, where traditional English breakfast meets 
                modern café culture. Located in the heart of Reading's city centre, 
                we've made it our mission to serve the perfect all-day breakfast 
                experience.
              </p>
              <p>
                Our name reflects our commitment to the personal touch – like the 
                little apron worn by generations of home cooks who poured love 
                into every meal. We believe great food starts with fresh, quality 
                ingredients and is finished with genuine care.
              </p>
              <p>
                ...
                is your neighbourhood gathering place for comfort, quality, and community.
              </p>
              <p className="text-coffee-medium font-medium">
                We're continuously improving our menu to bring you more variety 
                while maintaining our focus on exceptional breakfast and coffee experiences.
              </p>
            </div>
          </div>
