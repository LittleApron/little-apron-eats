      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            ...
            Our menu focuses on the perfect all-day English breakfast experience.
          </p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {menuData.map((category, categoryIndex) => (
            <Card key={categoryIndex} className="coffee-card bg-card border-border/50">
              <CardHeader>
        ...
        <div className="mt-12 text-center">
          <p className="text-muted-foreground mb-4">
            All items are freshly prepared to order. Please inform us of any dietary requirements.
          </p>
          <div className="inline-flex items-center space-x-2 text-coffee-medium">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            </svg>
            <span className="text-sm font-medium">Vegetarian options available</span>
          </div>
        </div>
      </div>
    </section>
